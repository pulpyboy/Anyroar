...
to_download = [eno for eno in nondhs if not os.path.exists(os.path.join(out_path, f"{eno}_1.jpg"))]
print()
skipped = []
to_download = []
for eno in nondhs:
...
print(f"🚀 Ready to download 0/{len(to_download)} Nondhs...\n")
